public class Book {
    ...
    public static Book make (String artist, String title, String genreName, String reservePriceSt) {
        try {
            int reservePrice = Integer.parseInt(reservePriceSt);
    ...
    public int compare(Book that) {
        ...
        return Integer.compare(reservePrice, that.reservePrice); //1,-1,0
    }
