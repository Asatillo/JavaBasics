...
class Main {
    public static void main(String[] args) {
        Book pbook = new PrintedBook("author", "title", 100, CoverType.Softcover );
        System.out.println(pbook);
        EBook ebook = new EBook("Eauthor", "Etitle", 100, 16);
        System.out.println(ebook);
        System.out.println();
        System.out.println(pbook.createReference("articlename", 10, 70));
        System.out.println(ebook.createReference("Earticlename", 9, 77));
