...
class Article {
    ...
    private void printReference(Book book, int from, int to) {
      ...
      /* Book, PrintedBook and EBook have a proper createReference() method, that takes care of proper reference creation.
        Note here the caller doesn't even interested in if book is a Book, PrintedBook or EBook, just the fact that every
...
/* The Liskov Substitution Principle (LSP) is one of five SOLID object-oriented design principles.
 It states that a superclass object should be replaceable with a subclass object without breaking the 
